# Generated by Django 4.2.14 on 2024-08-22 13:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analyse', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='demande.analysedemande', verbose_name='Analyse de la demande')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='options.status', verbose_name='Statut de la demande')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='analysedemande',
            name='status',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='options.status', verbose_name='Statut de la demande'),
        ),
        migrations.AddField(
            model_name='analysedemande',
            name='updated_by',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='analyse_updated', to=settings.AUTH_USER_MODEL, verbose_name="Agent auteur de la dernière mise à jour de l'analyse"),
        ),
        migrations.AddField(
            model_name='analysedemande',
