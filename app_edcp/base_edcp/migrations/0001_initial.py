...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('niv_validation', models.IntegerField(default=0, verbose_name='Niveau de Validation')),
                ('group', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='auth.group')),
                ('group_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='options.groupname', verbose_name='Nom du Groupe')),
            ],
        ),
        migrations.CreateModel(
            name='Enregistrement',
            fields=[
                ...
                ('pays', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='options.pays', verbose_name='Pays')),
                ('secteur', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='options.secteur', verbose_name="Secteur d'Activité")),
                ('type_piece', models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.SET_NULL, to='options.typepiece', verbose_name="Type de pièce d'identité")),
                ('typeclient', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='options.typeclient', verbose_name="Type d'organisation")),
