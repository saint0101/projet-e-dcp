...
urlpatterns = [
    ...
    path('designation-cabinet/org=<int:org>/', views.designate_cabinet, name='designation_cabinet'), # page de désignation d'un DPO (page 1)
    path('edit/<int:pk>/', views.DPOUpdateView.as_view(), name='edit'), # page d'édition du DPO
    path('edit-cabinet/<int:pk>/', views.DPOUpdateCabinet.as_view(), name='edit_cabinet'), # page d'édition du DPO
    ...
    path('cabinet/<int:pk>/', views.designation_detail, name='designation_detail'),
    path('<int:pk>/', views.correspondant_detail, name='detail'),
    path('<int:pk>/<str:action>/', views.correspondant_detail, name='detail'),
