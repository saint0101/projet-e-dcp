...
class Correspondant(models.Model):
  ...
  moyens_humains =models.CharField(max_length=255, null=True, blank=True, verbose_name='Moyens humains mis à la disposition du Correspondant')
  experiences = models.TextField(null=True, blank=True, verbose_name='Experiences et diplômes')
  ...
  def __str__(self):
    ...
    return self.user.nom + ' ' + self.user.prenoms
